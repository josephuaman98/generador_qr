                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" style="display: flex; align-items: center;">
                                    <h4 class="card-title" style="flex: 1; text-align: center; margin: 0;">Listado de QR Generados</h4>
                                    {{-- @can('crear-usuario') --}}
                                        <a class="btn btn-primary waves-effect waves-float waves-light" href="{{ route('generador.create') }}">Generar nuevo QR</a>
                                    {{-- @endcan --}}
                                </div>
                                <div class="card-body">
