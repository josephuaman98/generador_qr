                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Lista de los Deportista</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" style="display: flex; align-items: center;">
                                    <h4 class="card-title" style="flex: 1; text-align: center; margin: 0;">LISTA DE LOS DEPORTISTAS</h4>
                                    {{-- @can('crear-usuario') --}}
                                        <a class="btn btn-primary waves-effect waves-float waves-light" href="{{ route('deportista.create') }}">Registrar a un Deportista</a>
                                    {{-- @endcan --}}
                                </div>
                                <div class="card-body">
...
@section('scripts')
    ...
    {{-- <script>
        function fetchUsuarios(search, page, perPage, sort, direction) {
            $.ajax({
        ...
        $(document).ready(function() {
            ...
            $('#search-input').on('keyup', debounce(function() {
                ...
                fetchUsuarios(search, null, perPage, sort, direction);
            }, 300));
            ...
            $(document).on('click', '#pagination-links a', function(e) {
                ...
                let sort = '{{ $sort }}';
                let direction = '{{ $direction }}';
                fetchUsuarios(search, page, perPage, sort, direction);
            });
        });
    </script>
     --}}
